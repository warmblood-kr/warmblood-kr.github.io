...
이 그룹은 OOPSLA 91에서 랄프 존슨과 존 블리사이디스가 [대화에 합류](https://wiki.c2.com/?KentAndRalphAtTheArchitectureWorkshop)하면서 본격적으로 이루여졌습니다. 이로부터 4인방의 디자인 패턴 작업의 기반을 다져갔습니다.
...
그러나 우리는 무엇을 놓치고 있을까요? 패턴 언어 개념의 초기 차용이 소프트웨어 구축 방식을 깊이 있게 형성했다면, The Nature of Order의 더 풍부한 프레임워크는 우리에게 어떤 것을 제공할 수 있을까요?
...
실제적으로 이는 설계 논의 중에 다른 질문을 하는 것을 의미할 수 있습니다: 이 솔루션이 우리의 아키텍처에서 명확하고 강력한 중심을 만들어내는가? 의미 있는 경계를 설정하는가? 요구사항이 발전하면서 시스템이 자연스럽게 펼쳐질 수 있도록 하는가? 이러한 고려사항은 기존의 기술적 기준을 보완할 수 있습니다.
